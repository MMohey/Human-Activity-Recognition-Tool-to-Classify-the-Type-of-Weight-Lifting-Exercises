...
```{r ref.label="load_libraries", message=FALSE, warning=FALSE, include=FALSE}
...
```{r ref.label="var_imp_plot", echo=FALSE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE}
# Figure for Variable Importance Plot
```

```{r ref.label="models_summary", echo=FALSE, fig.height=10, fig.width=8, message=FALSE, warning=FALSE}
...
```{r stop_parallel, echo=FALSE, message=FALSE, warning=FALSE}
stopCluster(cluster)
registerDoSEQ()
```

```{r models_summary, message=FALSE, warning=FALSE}
...
```{r var_imp_plot, message=FALSE, warning=FALSE}
library(ggplot2)
library(grid)
library(gridExtra)
...
```{r predictors_count_plot, message=FALSE, warning=FALSE}
