---
title: "Human_Activity_Recognition_1_0"
author: "Moh A"
date: "11/04/2017"
output:
  html_document:
...
```{r ref.label="load_libraries", echo=FALSE, warning=FALSE}
# Load the libraries needed.
```

```{r ref.label="data_download_read", echo=FALSE, message=FALSE, warning=FALSE}
# Download the Data and read it into R
```

```{r ref.label="count_classe_table", echo=FALSE, warning=FALSE}
...
```{r ref.label="barplot_username_classe", message=FALSE, warning=FALSE, include=FALSE}
...
```{r ref.label="data_cleaning", message=TRUE, warning=FALSE, include=FALSE}
# Data cleaning step
```
...
```{r data_download_read, echo=FALSE, message=FALSE, warning=FALSE}
...
```{r data_cleaning, message=FALSE, warning=FALSE, tidy=TRUE}
...
```{r start_parallel, message=FALSE, warning=FALSE}
library(parallel)
library(doParallel)
library(mlbench)
...
```{r lda_model, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
...
```{r rf_model, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
intervalStart <- Sys.time()
...
```{r nnet_model, eval=FALSE, message=FALSE, warning=FALSE, include=FALSE}
intervalStart <- Sys.time()
...
```{r models_summary, echo=TRUE, message=FALSE, warning=FALSE}
...
```{r var_imp_plot, echo=TRUE, fig.height=6, fig.width=10, message=FALSE, warning=FALSE}
par(mfrow=c(1,3))
...
```{r predictors_count_plot, echo=TRUE, fig.height=8, fig.width=10, message=FALSE, warning=FALSE}
